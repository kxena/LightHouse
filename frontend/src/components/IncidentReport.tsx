        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="rounded-3xl bg-white/65 backdrop-blur-sm shadow-[0_10px_30px_rgba(0,0,0,0.08)] ring-1 ring-black/5 p-6">
              <div className="rounded-2xl bg-white p-6">
                ...
                <p className="text-center text-gray-700 leading-relaxed max-w-lg mx-auto">
                  Power outages reported across downtown area. Estimated
                  restoration time:
            ...
            <div className="rounded-3xl bg-white/65 backdrop-blur-sm shadow-[0_10px_30px_rgba(0,0,0,0.08)] ring-1 ring-black/5 p-6">
              <div className="rounded-2xl bg-white p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="inline-flex h-3.5 w-3.5 rounded-full bg-red-500 shadow-[0_0_0_6px_rgba(239,68,68,0.18)]" />
                </div>
          ...
          <div className="lg:col-span-6">
            <div className="rounded-3xl bg-white/65 backdrop-blur-sm shadow-[0_10px_30px_rgba(0,0,0,0.08)] ring-1 ring-black/5 p-4">
              <div className="rounded-2xl bg-white p-4 lg:p-5 ring-2 ring-blue-300/60 shadow-[0_8px_20px_rgba(30,64,175,0.15)]">
                <div className="space-y-5">
                  {Array.from({ length: 3 }).map((_, i) => (
                    <div
                      key={i}
                      className="pb-4 border-b last:border-b-0 border-gray-200/70"
                    >
